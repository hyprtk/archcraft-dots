...
SAVE_DIR=$(cat ~/archcraft-dots/scripts/settings/screenshot-folder)
SAVE_FILENAME=$(cat ~/archcraft-dots/scripts/settings/screenshot-filename)
eval screenshot_folder="$SAVE_DIR"
eval NAME="$SAVE_FILENAME"

# Notifications
source "$HOME/archcraft-dots/scripts/notification-handler"
APP_NAME="Screen Capture"
NOTIFICATION_ICON="camera-photo-symbolic"

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat $HOME/archcraft-dots/scripts/settings/screenshot-editor)"
