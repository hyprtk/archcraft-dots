...
FALLBACK="$HOME/archcraft-dots/Wallpapers/default.png"
...
killall waybar 2>/dev/null; ~/archcraft-dots/waybar/launch.sh
~/archcraft-dots/papirus-icons/scripts/change-icons.sh