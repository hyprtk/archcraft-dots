...
echo ""
yay -Rcs sddm-git --noconfirm
sudo pacman -Rcs sddm --noconfirm
...
echo ""
yay -S bibata-cursor-theme trizen sublime-text-4 sddm-theme-sugar-candy-git pacseek pamac-all libpamac-full pamac-cli --noconfirm
echo ""
